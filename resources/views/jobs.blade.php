                    ...
                    <div class="product-list__single-inner">
                        <div class="product-list__img-box p-4">
                            <div class="jobs-page__img">
                                <img src="{{asset('webassets/assets/images/favicons/apple-touch-icon.webp')}}" alt="">
                            </div>
...
{{-- <script async src="{{asset('webassets/assets/js/mainjs.single_product.js')}}"></script> <script async src="{{asset('webassets/assets/js/mainjs.js')}}"></script> --}}
