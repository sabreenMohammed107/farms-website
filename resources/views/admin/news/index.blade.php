                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-150px sorting" tabindex="0" aria-controls="kt_ecommerce_category_table"
                                    rowspan="1" colspan="1" aria-label="الخبر: activate to sort column ascending">
                                     الخبر</th>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end pe-0">
                                        ...
                                        <form id="delete_{{ $row->id }}"
                                            action="{{ route('news.destroy', $row->id) }}" method="POST"
                                            style="display: none;">
                                            @csrf
                                                    ...
                                                    <div class=" mb-8 row">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <div class="symbol-label fs-3 bg-light-danger text-danger">
                                                                <img src="{{ asset('uploads/news') }}/{{ $row->image }}"
                                                                    class="w-100" alt="">
                                                            </div>
                                                            <!--end::Label-->
                                                        </div>
                                                        <div class="col-md-12">
                                                            <!--begin::Label-->
                                                            <label for="name"
                                                                class=" col-form-label text-md-end"> عنوان الخبر :</label>
                                                            <span> {{ $row->title }}
                                                            </span>
                                                            <!--end::Label-->
                                                        </div>
