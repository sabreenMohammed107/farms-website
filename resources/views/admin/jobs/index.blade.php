    ...
    <div class="toolbar" id="kt_toolbar">
        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                <!--begin::Title-->
                <h1 class="text-dark fw-bolder my-1 fs-2"> بيانات الوظائف</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                                ...
                                <tr>
                                    ...
                                    <td class="text-end pe-0">
                                        ...
                                        <form id="delete_{{ $row->id }}"
                                            action="{{ route('jobs.destroy', $row->id) }}" method="POST"
                                            style="display: none;">
                                            @csrf
                                            ...
                                            <div class="modal-content rounded">
                                                ...
                                                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                                                    ...
                                                    <div class="mb-13 text-center">
                                                        <!--begin::Title-->
                                                        <h1 class="mb-3">تفاصيل  الوظيفة</h1>
                                                        <!--end::Title-->
                                                    ...
                                                    <div class=" mb-8 row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <!--begin::Label-->
                                                            <label for="name"
                                                                class=" col-form-label text-md-end"> الوظيفة :</label>
                                                            <span> {{ $row->title }}
                                                            </span>
                                                            <!--end::Label-->
                                                        </div>
                                                    ...
                                                    <div class=" mb-8 row">
                                                        <div class="col-md-12">
                                                            <!--begin::Label-->
                                                            <label for="details"
                                                                class=" col-form-label text-md-end">البريد الإلكتروني :</label>
                                                            <span>  {{ $row->email }}</span>
                                                            <!--end::Label-->
                                                        </div>
