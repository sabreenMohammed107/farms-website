...
<html lang="ar">
	...
	<!--end::Head-->
    	...
    	<!--begin::Body-->
	<body id="kt_body" style="direction: rtl" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled aside-fixed aside-default-enabled">
       <!--begin::Root-->
        ...
        <div class="toolbar" id="kt_toolbar">
            <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                    <!--begin::Title-->
                    {{-- <h1 class="text-dark fw-bolder my-1 fs-2">الصفحة الرئيسية</h1> --}}
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
