...
<section class="why-choose-one about-us">
  <div class="why-choose-one__bg" style="background-image: url({{asset('webassets/assets/images/backgrounds/why-choose-one-bg.jpg')}});">
  </div>
    ...
    <div class="row">
      <div class="col-xl-6 col-lg-8">
        <div class="why-choose-one__left">
          <div class="section-title text-left">
            <span class="section-title__tagline">لماذا تختار <span class="inside-section-title">{!!$homedata ->why_us_title !!}</span></span>
    ...
    <div class="row">
      ...
      <div class="col-xl-6">
        <div class="about-us-one__left">
          <div class="about-us-one__img-box wow slideInLeft" data-wow-delay="100ms" data-wow-duration="2500ms">
